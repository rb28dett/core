...
class RB28DETTCreatePackage extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'rb28dett:create-package {name} {--path=}';
     ...
     * @var string
     */
    protected $description = 'Create a new rb28dett package {name : Package name} {--path : Location to create the package}';
