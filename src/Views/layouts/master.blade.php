@php
    ...
    $packages = \RB28DETT\RB28DETT\Packages::all();
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://gitcdn.xyz/cdn/RB28DETT/RB28DETT/feecc1c067d7fb9dd7e16b8524b591eae28455a3/src/Assets/css/style.css" />
        ...
        <link rel="stylesheet" href="https://gitcdn.xyz/cdn/RB28DETT/RB28DETT/feecc1c067d7fb9dd7e16b8524b591eae28455a3/src/Assets/css/notyf.min.css" />

        <!-- CSS Injection for packages -->
        @foreach ($packages as $package)
            {!! \RB28DETT\RB28DETT\Injector::inject('style', $package) !!}
        @endforeach

        @include('rb28dett::assets.css')
    ...
    <body>
            ...
            <div class="uk-container uk-container-expand">
                <nav class="uk-navbar-container" uk-navbar>
                    <div class="uk-navbar-left">
                        ...
                        <a href="{{ route('rb28dett::index') }}" class="uk-navbar-item uk-logo">{{ $settings->appname }}</a>
                    </div>
                            ...
                            <li class="uk-active">
                                ...
                                <div sty uk-dropdown="pos: bottom-center; mode: click; offset: -17;">
                                    <ul class="uk-nav uk-navbar-dropdown-nav">
                                        ...
                                        @foreach (\Aitor24\Localizer\Facades\LocalizerFacade::addNames(config('rb28dett.languages')) as $code => $name)
                            ...
                            <li class="uk-active">
                                ...
                                <div uk-dropdown="pos: bottom-right; mode: click; offset: -17;">
                                    <ul class="uk-nav uk-navbar-dropdown-nav">
                                        <!-- User Injector -->
                                        @foreach ($packages as $package)
                                            @php $items = \RB28DETT\RB28DETT\Injector::inject('user', $package) @endphp
                                            @if ($items)
                                                @php
                                                    $counter = 0;
                                            ...
                                            @endif
                                        @endforeach
                                        <li class="uk-nav-header">@lang('rb28dett::general.actions')</li>
                                        <li>
                                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                @lang('rb28dett::general.logout')
                                            </a>
        ...
        <div id="sidebar" class="tm-sidebar-left uk-background-default">
            <center>
                <div class="user">
                    ...
                    <span id="status" data-enabled="true" data-online-text="{{ __('rb28dett::general.online') }}" data-away-text="{{ __('rb28dett::general.absent') }}" data-interval="20000" class="uk-margin-top uk-label uk-label-success"></span>
                </div>
                <br />
            </center>
            <ul class="uk-nav-default" uk-nav="multiple: false">

                @foreach (\RB28DETT\RB28DETT\Menu::generate() as $menu)
        ...
        <script src="https://gitcdn.xyz/cdn/RB28DETT/RB28DETT/feecc1c067d7fb9dd7e16b8524b591eae28455a3/src/Assets/js/script.js"></script>
        <script src="https://gitcdn.xyz/cdn/RB28DETT/RB28DETT/feecc1c067d7fb9dd7e16b8524b591eae28455a3/src/Assets/js/status.js"></script>
        <script src="https://gitcdn.xyz/cdn/RB28DETT/RB28DETT/feecc1c067d7fb9dd7e16b8524b591eae28455a3/src/Assets/js/notyf.min.js"></script>

        @include('rb28dett::assets.js')

        @yield('js')

        <!-- JS Injection for packages -->
        @foreach ($packages as $package)
            {!! \RB28DETT\RB28DETT\Injector::inject('script', $package) !!}
        @endforeach
        ...
        <script>
            $(function() {
                ...
                {
                    $.post("{{ route('rb28dett_api::save_menu_action') }}", {
                        '_token': "{{ csrf_token() }}",
                        'menu': el.attr('id'),
                    });
                }
